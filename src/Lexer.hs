...
alex_base = Data.Array.listArray (0 :: Int, 41)
  [ 1
  , 0
  , 207
  , 67
...
alex_table = Data.Array.listArray (0 :: Int, 2015)
  [ 0
  , 20
  , 20
  , 20
...
alex_check = Data.Array.listArray (0 :: Int, 2015)
  [ -1
  , 0
  , 1
  , 2
...
alex_deflt = Data.Array.listArray (0 :: Int, 41)
  [ -1
  , -1
  , -1
  , -1
...
alex_accept = Data.Array.listArray (0 :: Int, 41)
  [ AlexAccNone
  , AlexAcc 30
  , AlexAcc 29
  , AlexAcc 28
...
alex_action_1 = \pos _ -> Token pos FUN
alex_action_2 = \pos _ -> Token pos LET
alex_action_3 = \pos _ -> Token pos IN
alex_action_4 = \pos _ -> Token pos ASSIGN
alex_action_5 = \pos _ -> Token pos BOT
alex_action_6 = \pos _ -> Token pos TOP
alex_action_7 = \pos _ -> Token pos COMMA
alex_action_8 = \pos _ -> Token pos COLON
alex_action_9 = \pos _ -> Token pos LPAREN
alex_action_10 = \pos _ -> Token pos RPAREN
alex_action_11 = \pos _ -> Token pos LBRACK
alex_action_12 = \pos _ -> Token pos RBRACK
alex_action_13 = \pos _ -> Token pos FORALL
alex_action_14 = \pos _ -> Token pos ARROW
alex_action_15 = \pos s -> Token pos $ IDLower s
alex_action_16 = \pos s -> Token pos $ IDUpper s
alex_action_17 = \pos s -> Token pos $ ERROR ("Lexing error: " ++ s)
